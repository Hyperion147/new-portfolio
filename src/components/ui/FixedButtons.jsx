  ...
  return (
    <div className="fixed bottom-7 right-7 flex flex-col z-50">
      <div className='relative group'>
        <span 
          className="absolute -inset-[2px] rounded-full animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#cb23ff_0%,#2c536a_50%,#c029ff_100%)] dark:bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)] opacity-100 transition-opacity duration-300"
          aria-hidden="true"
        />
        <a

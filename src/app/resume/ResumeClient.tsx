...
export default function ResumeClient() {
  ...
  const googleDriveUrl =
    "https://drive.google.com/file/d/12qG3WJMPRUQPlaLPaUjajII6GvxUsRrs/view?usp=sharing";

  return (
    <motion.section
      aria-label="Project gallery"
      className="bg-[#fff9f0] dark:bg-gray-900 min-h-screen overflow-x-hidden flex flex-col w-full"
